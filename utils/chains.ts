...
import { reservoirChains, customChains } from '@sh-reservoir0x/reservoir-sdk'
...
export const DefaultChain: ReservoirChain = {
  ...
  lightIconUrl: 'https://aurascan.io/assets/images/logo/title-logo.png',
  // Any url to display the logo of the chain in dark mode
  darkIconUrl: 'https://aurascan.io/assets/images/logo/title-logo.png',
  ...
  reservoirBaseUrl: auraTemp.baseApiUrl,
  ...
  routePrefix: process.env.NEXT_PUBLIC_ROUTE_PREFIX as string,
  ...
  //   {
  //     ...usdcCurrencyBase,
  //     contract: usdcContracts[evmos.id],
  //   },
  // ],
...
export default [
  ...
  // {
  //   ...evmosTestnet,
  //   reservoirBaseUrl: evmosTemp.baseApiUrl,
  //   proxyApi: '',
  //   routePrefix: 'evmos',
  //   checkPollingInterval: evmosTemp.checkPollingInterval,
  //   rpcUrls: {
  //     default: {
